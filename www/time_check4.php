				...
				echo "<table border='1px'>";
					...
					echo "<tr>";
						echo "<th align='center' colspan='2' style='background-color: rgba(124, 123, 150, 0.8);'>愛校日期</th>";
							...
							echo "<input type='date' name='str_date' id='str_date' value='$date' min = '$check_day_res[write_day]' max = '$today' />";
							echo "</td>";
